...
const sampleMessages = [
    ...
    {
        id: 4,
        text: "Вау, действительно потрясающе! Где это снято? Вау, действительно потрясающе! Где это снято? Вау, действительно потрясающе! Где это снято? Вау, действительно потрясающе! Где это снято? Вау, действительно потрясающе! Где это снято? Вау, действительно потрясающе! Где это снято? Вау, действительно потрясающе! Где это снято? Вау, действительно потрясающе! Где это снято? ",
        sender: "Вы",
        time: "14:33",
        isOwn: true,
    },
